...
hive_site()
{
    ...
    echo "      <value>jdbc:postgresql://$DATABASE_HOST:5432/$DATABASE_DB?createDatabaseIfNotExist=true</value>"
    ...
    echo "      <value>s3a://$S3_BUCKET/${S3_PREFIX}/</value>"
    echo "  </property>"
    ...
    echo "      <value>$S3_ENDPOINT_URL</value>"
    echo "  </property>"
